    ...
    const budgets = {
        minimalistisch: {
            ...
            fixed: [
                ...
                { name: 'Handy-Abo', amount: 30, category: 'fixed' },
            ...
            variable: [
                ...
                { name: 'Ausgang', amount: 100, category: 'variable', adjustable: true, min: 0 },
                { name: 'Kleider/Schuhe', amount: 60, category: 'variable', adjustable: true, min: 20 },
                { name: 'Streaming-Dienste', amount: 20, category: 'variable', adjustable: true, min: 0 },
                { name: 'Hobbys', amount: 60, category: 'variable', adjustable: true, min: 0 },
                { name: 'Essen auswärts', amount: 80, category: 'variable', adjustable: true, min: 0 },
                { name: 'Transport (ÖV)', amount: 80, category: 'variable' },
                { name: 'Beauty/Barber', amount: 40, category: 'variable', adjustable: true, min: 0 }
            ],
            savings: [
                { name: getGoalName(questionnaireData.q10), amount: 220, category: 'savings', adjustable: true, min: 50 }
            ]
        },
        ausgeglichen: {
            name: 'Ausgeglichen',
            ...
            fixed: [
                { name: 'Miete', amount: 1400, category: 'fixed', adjustable: true, min: 1200 },
                { name: 'Krankenkasse', amount: 350, category: 'fixed' },
                { name: 'Handy-Abo', amount: 50, category: 'fixed' },
                { name: 'Internet', amount: 50, category: 'fixed' },
                { name: 'Strom/Heizung (akonto)', amount: 100, category: 'fixed' }
            ],
            variable: [
                { name: 'Lebensmittel', amount: 500, category: 'variable', adjustable: true, min: 300 },
                { name: 'Ausgang', amount: 180, category: 'variable', adjustable: true, min: 0 },
                { name: 'Kleider/Schuhe', amount: 120, category: 'variable', adjustable: true, min: 20 },
                { name: 'Streaming-Dienste', amount: 35, category: 'variable', adjustable: true, min: 0 },
                { name: 'Hobbys', amount: 100, category: 'variable', adjustable: true, min: 0 },
                { name: 'Essen auswärts', amount: 150, category: 'variable', adjustable: true, min: 0 },
                { name: 'Rauchen/Vapes', amount: 100, category: 'variable', adjustable: true, min: 0 },
                { name: 'Transport (ÖV)', amount: 120, category: 'variable' },
                { name: 'Beauty/Barber', amount: 60, category: 'variable', adjustable: true, min: 0 }
            ],
            savings: [
                { name: getGoalName(questionnaireData.q10), amount: 285, category: 'savings', adjustable: true, min: 50 }
            ]
        },
        luxuriös: {
            name: 'Luxuriös',
